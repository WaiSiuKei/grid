  ...
  ***************************************************************************** */
  ...
  var GridModel = (function () {
      function GridModel(ds) {
          this.items = ds.map(function (i, idx) { return (__assign({}, i, { _gridId: idx })); });
      }
      return GridModel;
  }());
  ...
  var ViewCell = (function () {
      function ViewCell(container, row, cell, datum, col) {
          this.row = row;
          this.cell = cell;
          this.datum = datum;
          this.col = col;
  ...
  var ViewRow = (function () {
      function ViewRow(host, rowIndex, data, ctx) {
          this.ctx = ctx;
          this.mounted = false;
      ...
      ViewRow.prototype.mount = function (slibing) {
          this.mounted = true;
          if (slibing) {
              this.host.insertBefore(this.domNode, slibing.domNode);
          }
      ...
      ViewRow.prototype.mountCell = function (index) {
      ...
      ViewRow.prototype.unmountCell = function (index) {
          var cell = this.cellCache[index];
          if (cell) {
              cell.dispose();
      ...
      ViewRow.prototype.updateCell = function (headerMounted, margin) {
  ...
  var ViewHeaderRow = (function () {
      ...
      ViewHeaderRow.prototype.mount = function (index) {
          var cell = this.cellCache[index];
          if (!cell) {
      ...
      ViewHeaderRow.prototype.unmount = function (index) {
          var cell = this.cellCache[index];
          if (cell) {
              cell.dispose();
              delete this.cellCache[index];
  ...
  var GridView = (function () {
      function GridView(container, ctx) {
          this.ctx = ctx;
          this.rowCache = Object.create(null);
          GridView.counter++;
      ...
      GridView.prototype.createElement = function (container) {
          var _this = this;
          ...
          var headerHeight = getContentHeight(this.header.domNode);
          body.style.height = getContentHeight(this.domNode) - headerHeight + 'px';
      };
      GridView.prototype.layout = function (height, width) {
      ...
      GridView.prototype.getContentHeight = function () {
          return this.ctx.model.items.length * this.ctx.options.rowHeight;
      };
      GridView.prototype.getContentWidth = function () {
          return this.ctx.columns.reduce(function (acc, col) { return acc + (col.width || 80); }, 0);
      };
      Object.defineProperty(GridView.prototype, "viewHeight", {
          get: function () {
      ...
      Object.defineProperty(GridView.prototype, "scrollHeight", {
      ...
      Object.defineProperty(GridView.prototype, "viewWidth", {
          get: function () {
              var scrollDimensions = this.scrollableElement.getScrollDimensions();
      ...
      Object.defineProperty(GridView.prototype, "scrollWidth", {
      ...
      Object.defineProperty(GridView.prototype, "scrollTop", {
          get: function () {
              var scrollPosition = this.scrollableElement.getScrollPosition();
              return scrollPosition.scrollTop;
          },
          set: function (scrollTop) {
              var scrollHeight = this.getContentHeight() + 10;
              this.scrollableElement.setScrollDimensions({ scrollHeight: scrollHeight });
      ...
      Object.defineProperty(GridView.prototype, "scrollLeft", {
          set: function (scrollLeft) {
              var scrollWidth = this.getContentWidth() + 10;
              this.scrollableElement.setScrollDimensions({ scrollWidth: scrollWidth });
      ...
      GridView.prototype.render = function (arg1, arg2) {
          var scrollTop = 0;
          var scrollLeft = 0;
          var viewHeight;
          var viewWidth;
          ...
          if (hasVerticalDelta) {
              ...
              for (i = this.indexAfter(renderBottom) - 1, stop_1 = this.indexAt(Math.max(thisRenderBottom, renderTop)); i >= stop_1; i--) {
                  this.insertItemInDOM(i);
              }
              for (i = Math.min(this.indexAt(this.lastRenderTop), this.indexAfter(renderBottom)) - 1, stop_1 = this.indexAt(renderTop); i >= stop_1; i--) {
                  this.insertItemInDOM(i);
              }
              for (i = this.indexAt(this.lastRenderTop), stop_1 = Math.min(this.indexAt(renderTop), this.indexAfter(thisRenderBottom)); i < stop_1; i++) {
                  this.removeItemFromDOM(i);
              }
              for (i = Math.max(this.indexAfter(renderBottom), this.indexAt(this.lastRenderTop)), stop_1 = this.indexAfter(thisRenderBottom); i < stop_1; i++) {
                  this.removeItemFromDOM(i);
              }
              var topItem = this.indexAt(renderTop);
              var t = (this.getItemTop(topItem) - renderTop);
          ...
          for (var index in this.rowCache) {
              var row = this.rowCache[index];
              row.updateCell(mounted, margin);
          }
      };
      GridView.prototype.insertItemInDOM = function (index) {
          var row = this.rowCache[index];
          if (!row) {
          ...
          if (row.mounted)
              return;
          var nextRow = this.rowCache[index + 1];
          row.mount(nextRow);
      };
      GridView.prototype.removeItemFromDOM = function (index) {
          var row = this.rowCache[index];
          if (row) {
              row.dispose();
      ...
      GridView.prototype.getItemTop = function (index) {
          return index * 20 + (index ? 1 : 0);
      };
      GridView.prototype.indexAt = function (position$$1) {
          var left = 0;
          var l = this.ctx.model.items.length;
          var right = l - 1;
          var center;
          var r = this.ctx.options.rowHeight;
          while (left < right) {
              center = Math.floor((left + right) / 2);
              var top_1 = this.getItemTop(center);
              if (position$$1 < top_1) {
                  right = center;
              }
      ...
      GridView.prototype.indexAfter = function (position$$1) {
          return Math.min(this.indexAt(position$$1) + 1, this.ctx.model.items.length);
      };
      GridView.counter = 0;
      return GridView;
  }());
  ...
  var Grid = (function () {
      function Grid(container, ds, col, options) {
          ...
          var opt = this.validateAndEnforceOptions(options);
          var model = new GridModel(ds);
          var columns = this.validatedAndEnforeColumnDefinitions(col, opt.defaultColumnWidth);
          var ctx = new GridContext(model, columns, opt);
          this.view = new GridView(this.container, ctx);
      }
      Grid.prototype.validateAndEnforceOptions = function (opt) {
          return Object.assign({}, opt, GRID_DEFAULT);
      };
      Grid.prototype.validatedAndEnforeColumnDefinitions = function (col, defaultWidth) {
          var validatedCols = [];
