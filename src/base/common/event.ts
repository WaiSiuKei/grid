...
import { once as onceFn } from 'src/base/common/functional';
import { combinedDisposable, Disposable, IDisposable, toDisposable } from 'src/base/common/lifecycle';
...
export class EventMultiplexer<T> implements IDisposable {
  ...
  add(event: Event<T>): IDisposable {
    const e: { event: Event<T>; listener: IDisposable | null; } = { event: event, listener: null };
    this.events.push(e);
