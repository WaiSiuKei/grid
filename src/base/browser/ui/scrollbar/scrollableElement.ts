...
import { ScrollableElementChangeOptions, ScrollableElementCreationOptions, ScrollableElementResolvedOptions } from 'src/base/browser/ui/scrollbar/scrollableElementOptions';
import { VerticalScrollbar } from 'src/base/browser/ui/scrollbar/verticalScrollbar';
...
import { IDisposable, dispose } from 'src/base/common/lifecycle';
import * as platform from 'src/base/common/platform';
import { INewScrollDimensions, INewScrollPosition, IScrollDimensions, IScrollPosition, ScrollEvent, Scrollable, ScrollbarVisibility } from 'src/base/common/scrollable';
import { addDisposableListener, EventType, scheduleAtNextAnimationFrame } from 'src/base/browser/dom';
