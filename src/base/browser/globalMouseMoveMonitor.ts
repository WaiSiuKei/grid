...
import { IframeUtils } from 'src/base/browser/iframe';
import { StandardMouseEvent } from 'src/base/browser/mouseEvent';
import { Disposable, IDisposable, dispose } from 'src/base/common/lifecycle';
import { addDisposableThrottledListener } from 'src/base/browser/dom';
